            ...
            <header className="w-full bg-background z-10 sticky top-0 border-b border-border">
                    ...
                    {currentStep > 0 && (
                        <div className="hidden lg:flex flex-1 items-center justify-center max-w-2xl w-full px-4">
                            <div className="flex items-center w-full justify-between relative">
                                <div className="absolute left-0 right-0 top-1/2 -translate-y-1/2 h-px bg-border -z-10" />
                ...
                {currentStep > 0 && (
                    <div className="lg:hidden w-full px-4 pb-3">
                        <div className="flex items-center w-full justify-between relative">
                            <div className="absolute left-0 right-0 top-4 h-px bg-border -z-10" />
                            ...
                            {steps.map((step) => {
                                ...
                                return (
                                    <div key={step.number} className="flex flex-col items-center gap-1.5 bg-background px-1">
                                        ...
                                        <span className={`text-[8px] sm:text-[9px] font-bold uppercase tracking-widest transition-colors ${isActive ? 'text-primary' : 'text-muted-foreground'
                                            }`}>
                                            {step.label}
                                        </span>
                                    </div>

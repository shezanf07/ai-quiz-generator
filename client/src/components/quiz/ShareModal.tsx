    ...
    <div className="w-full max-w-2xl flex flex-col items-center gap-6 sm:gap-8">
      ...
      <div className="relative">
        ...
        <div className="w-20 h-20 bg-primary rounded-2xl flex items-center justify-center relative z-10 shadow-lg transform rotate-3">
          <Check size={40} className="text-background" strokeWidth={3} />
        </div>
      ...
      <div className="w-full bg-card border border-border rounded-2xl p-5 sm:p-8 shadow-2xl mt-2 sm:mt-4">
        ...
        <div className="relative flex items-center py-8">
          ...
          <span className="shrink-0 mx-4 text-[10px] tracking-widest uppercase text-muted-foreground font-bold">OR</span>
          <div className="grow border-t border-border"></div>
        </div>
        ...
        <div className="flex flex-col items-center gap-8 pb-4">
          ...
          <button className="flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors text-[11px] font-bold uppercase tracking-widest">
            <Download size={14} />
            Download QR Code
          </button>
        </div>

// Review card. It shows one submitted answer in the result review.
    ...
    return (
        <div className="w-full bg-card border border-border rounded-xl p-6 md:p-8 flex flex-col gap-6 relative">
            ...
            <div className="flex items-start justify-between mb-2">
                ...
                <div className={`px-2 py-1 flex items-center justify-center rounded-[3px] text-[9px] font-bold tracking-widest uppercase ${isCorrect ? 'bg-muted text-muted-foreground border border-border' : 'bg-[#e57a7a]/10 text-[#e57a7a] border border-[#e57a7a]/20'
                    }`}>
            ...
            {/* Show the student's selected answer first. */}
            ...
            {/* For wrong answers, show the correct answer below. */}

...
export default function ResultsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0D1511] text-[#F2EBD9] flex flex-col font-sans">
      {/* Top Navbar */}
      <header className="w-full px-6 md:px-12 py-6 flex flex-col items-start bg-[#0D1511]">
        <Link to="/" className="flex items-center gap-3 font-serif hover:opacity-80 transition-opacity">
          <BookOpen className="text-[#F2EBD9]" size={24} opacity={0.7} />
          <span className="text-xl font-bold italic text-[#F2EBD9] opacity-80">Quizly</span>
        </Link>
      </header>

      <main className="flex-1 w-full max-w-4xl mx-auto px-4 md:px-6 py-8 flex flex-col">
        {/* Score Ring Header */}
        <div className="flex flex-col items-center justify-center pt-8 pb-16 border-b border-[#1f3329]">
          ...
          <p className="text-[#8A9C94] text-[15px] mb-8">You answered 10 of 12 questions correctly.</p>
          
          <div className="flex items-center gap-2 bg-[#15221c] border border-[#1f3329] rounded-full px-4 py-1.5 text-[10px] font-bold text-[#8A9C94] uppercase tracking-widest">
            <Check size={14} className="text-[#8A9C94]" />
            Passed
          </div>
        </div>
        ...
        <div className="pt-12 pb-24 flex flex-col gap-8">
          <div className="flex items-end justify-between mb-2">
            ...
            <span className="text-[#C69B35] text-[10px] font-bold uppercase tracking-[0.15em]">12 Questions</span>
          </div>
        ...
        {/* Footer Actions */}
        <div className="w-full py-12 flex flex-col sm:flex-row items-center justify-center gap-8 border-t border-[#1f3329]">
          <Link to="/quiz/1" className="bg-[#B28228] hover:bg-[#976E22] text-[#F2EBD9] text-[11px] font-bold uppercase tracking-[0.15em] px-12 py-4 rounded-[3px] transition-colors shadow-lg text-center w-full sm:w-auto">
            Retake Quiz
          </Link>
          <Link to="/" className="text-[#C69B35] hover:text-[#F2EBD9] text-[11px] font-bold uppercase tracking-[0.15em] transition-colors text-center w-full sm:w-auto">
            Back to Home
          </Link>
        </div>
      </main>
